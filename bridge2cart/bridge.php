...
class M1_Config_Adapter
{
  ...
  public function detectCartType()
  {
    ...
    //Xcart
    if ((@file_exists(M1_STORE_BASE_DIR . 'include/classes/class.DataStorage.php') && @file_exists(M1_STORE_BASE_DIR . 'config.php')) || @file_exists(M1_STORE_BASE_DIR . '/etc/config.php')) {
      return 'Xcart';
    }
...
class M1_Pdo
{
  public $config = null; // config adapter
  public $result = array();
  public $noResult = array('delete', 'update', 'move', 'truncate', 'insert', 'set', 'create', 'drop', 'replace', 'alter', '/*', 'load');
