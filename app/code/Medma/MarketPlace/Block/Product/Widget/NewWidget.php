 ...
 */
namespace Medma\MarketPlace\Block\Product\Widget;
    ...
    protected function _getProductCollection()
    {
        switch ($this->getDisplayType()) {
            case self::DISPLAY_TYPE_NEW_PRODUCTS:
                $collection = parent::_getProductCollection()->groupByAttribute('name_keyword')->addFieldToFilter('approved', 1)->addAttributeToSelect('vendor')
                    ->setPageSize($this->getPageSize())
                    ->setCurPage($this->getCurrentPage());
                break;
            default:
                $collection = $this->_getRecentlyAddedProductsCollection()->groupByAttribute('name_keyword')->addFieldToFilter('approved', 1)->addAttributeToSelect('vendor');
                break;
        }
        return $collection;
    }
