...
namespace Medma\MarketPlace\Block\Adminhtml\Import\Edit;
...
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    {
        $html = '<span id="vendor-sample-file-span" class="no-display"><a id="vendor-sample-file-link" href="#">'
            . __('Download Products Sample File')
            . '</a></span>';
        return $html;
    }
}
