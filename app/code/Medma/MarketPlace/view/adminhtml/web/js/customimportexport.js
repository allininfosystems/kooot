...
//<![CDATA[
    ...
    vendorImport = {
        ...
        showSampleFile: function (entityId) {
            var vendorsampleFileSpan = jQuery('#vendor-sample-file-span');
            if (entityId) {
                var vendorsampleFileLink = this.sampleFilesBaseUrl.replace('entity-name', entityId);
                jQuery('#vendor-sample-file-link').attr('href', vendorsampleFileLink);
                if (vendorsampleFileSpan.is(':hidden')) {
                    vendorsampleFileSpan.show();
                }
            } else {
                vendorsampleFileSpan.hide();
            }
        },
