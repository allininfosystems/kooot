...
namespace Medma\MarketPlace\Controller\Adminhtml\Import;

use Magento\Framework\Component\ComponentRegistrar;
use Medma\MarketPlace\Controller\Adminhtml\Import as ImportController;
...
{
    const SAMPLE_FILES_MODULE = 'Medma_MarketPlace';
